...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "top.search": "Search projects, notes or decisions…",
        "top.search_tip": "Type a word and press Enter. DevNest searches your local projects, notes and decisions.",
    ...
    "tr": {
        ...
        "top.search": "Proje, not veya karar ara…",
        "top.search_tip": "Bir kelime yazıp Enter'a basın. DevNest bu bilgisayardaki projelerinizde, notlarınızda ve kararlarınızda arar.",
